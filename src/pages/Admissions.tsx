...
function Admissions() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const {
      childName, dob, program, parentName, contact, email, address
    } = formData;
    ...
    window.location.href = `mailto:admissions@deeveen.edu?subject=${subject}&body=${body}`;
  };
            ...
            <div className="card p-4 sm:p-6">
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                <div>
                  ...
                  <input type="text" name="childName" required className="input-field w-full" onChange={handleChange} />
                </div>
                <div>
                  <label className="block text-gray-700 mb-2">Date of Birth *</label>
                  <input type="date" name="dob" required className="input-field w-full" onChange={handleChange} />
                </div>
                <div>
                  <label className="block text-gray-700 mb-2">Program Applied For *</label>
                  <select name="program" className="input-field w-full" onChange={handleChange}>
                ...
                <div>
                  ...
                  <input type="text" name="parentName" required className="input-field w-full" onChange={handleChange} />
                </div>
                <div>
                  <label className="block text-gray-700 mb-2">Contact Number *</label>
                  <input type="tel" name="contact" required className="input-field w-full" onChange={handleChange} />
                </div>
                <div>
                  <label className="block text-gray-700 mb-2">Email Address *</label>
                  <input type="email" name="email" required className="input-field w-full" onChange={handleChange} />
                </div>
                <div>
                  <label className="block text-gray-700 mb-2">Address</label>
                  <textarea name="address" rows={3} className="input-field w-full" onChange={handleChange}></textarea>
                </div>
